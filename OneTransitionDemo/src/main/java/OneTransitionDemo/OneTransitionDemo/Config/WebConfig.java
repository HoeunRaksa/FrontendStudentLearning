    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/student_score/add").permitAll()
                        .requestMatchers("/api/student_score/**").authenticated()
                        .requestMatchers("/api/user/register", "/api/user/login", "/api/uploads/profile/**", "/upload/**").permitAll()
                        .requestMatchers("/api/reports/**", "/api/materials/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/answer-feedback/**").hasRole("INSTRUCTOR")
